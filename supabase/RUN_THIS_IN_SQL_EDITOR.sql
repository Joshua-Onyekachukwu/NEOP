-- ============================================================
-- NEOP: ALL-IN-ONE — Clean + Create Function + Run 20M Sim
-- Paste this entire file into Supabase SQL Editor and run it
-- ============================================================

-- STEP 1: Fix NOT NULL constraints for disrupted PUs
-- ============================================================
...
-- STEP 2: Clean old data (CASCADE needed because of FK constraints)
-- ============================================================
TRUNCATE TABLE party_results, result_submissions, incidents RESTART IDENTITY CASCADE;
...
SELECT '✅ STEP 2: Cleanup complete' AS result;


-- STEP 3: Create the simulation function
-- ============================================================
-- This MUST run in SQL Editor (not via exec_sql) because of $$ dollar-quoting
...
BEGIN
  -- Clear old data
  TRUNCATE TABLE party_results, incidents RESTART IDENTITY CASCADE;
...
SELECT '✅ STEP 3: run_sim_upgraded function created' AS result;


-- STEP 4: Run the 20M simulation (takes ~40 seconds)
-- ============================================================
...
SELECT
  ...
  ROUND(sum(f.votes::BIGINT) * 100.0 / NULLIF((SELECT sum(total_votes) FROM result_submissions WHERE party_votes IS NOT NULL), 0), 1) AS pct
FROM result_submissions,
...
-- Simulation config
SELECT status, total_results_submitted, started_at, last_tick_at
